...
import { IconLogo, IconSpark, IconChart, IconBolt, IconWallet, IconCheck, IconSettings } from "@/components/ui-custom/CustomIcon";
...
const NAV = [
  ...
  { to: "/businessos/finance", key: "nav.finance", Icon: IconWallet, exact: false },
